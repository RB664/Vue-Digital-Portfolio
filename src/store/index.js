...
export default createStore({
  state: {
    projects: [
      ...
      {
          "id": 5,
          "image": "https://i.postimg.cc/d3YFyxHT/Rainbow-Designed-by-Ridhaa-Benjamin.png",
          "description": "Rainbow",
      ...
      {
          "id": 6,
          "image": "https://i.postimg.cc/WpBF9NKM/Calculator-Designed-by-Ridhaa-Benjamin.png",
...
testimonials:[
  {
     ...
     "comment":"I am delighted to be called upon as a reference for Ridhaa. He has a gentle personality which makes him a pleasure to work with. In addition Ridhaa, he is a smart and dedicated person." 
  },
  {
     "id":2,
     "name":"Ra'ees",
